document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function fetchBlogDetails() {
        try {
            ...
            // ✅ SEO: Initialize SEO meta tags and structured data
            if (typeof initBlogPostSEO === 'function') {
                initBlogPostSEO(blog);
            }

            // ✅ Analytics: Track blog post view
            if (typeof trackBlogView === 'function') {
            ...
            shareButtons.innerHTML = `
                ...
                <a href="https://api.whatsapp.com/send?text=${encodeURIComponent(shareText + ' ' + currentUrl)}" target="_blank" class="share-btn whatsapp" onclick="if(typeof trackSocialShare === 'function') trackSocialShare('WhatsApp', '${blog.title.replace(/'/g, "\\'")}')">
                ...
                <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}&url=${encodeURIComponent(currentUrl)}" target="_blank" class="share-btn twitter" onclick="if(typeof trackSocialShare === 'function') trackSocialShare('Twitter', '${blog.title.replace(/'/g, "\\'")}')">
                ...
                <a href="https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(currentUrl)}" target="_blank" class="share-btn linkedin" onclick="if(typeof trackSocialShare === 'function') trackSocialShare('LinkedIn', '${blog.title.replace(/'/g, "\\'")}')">
            ...
            if (blog.image_alt) {
                blogImage.alt = blog.image_alt;
            } else {
                blogImage.alt = blog.title; // Fallback to title
            }
